                ...
                },
                {
                    ...
                    FlagTypes: [
                        ...
                        },
                        {
                            ...
                            ReportType: 'AnswerNotAnAnswer',
                            GetComment: function (userDetails) { return userDetails.Reputation == 1  ?'Welcome to StackOverflow '+ userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) + '. However, this does not provide an answer to the question.You can [search for similar questions](//stackoverflow.com/search), ' +
                            ...
                            :(userDetails.Reputation < 50
                              ? userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) + ', this does not provide an answer to the question. You can [search for similar questions](//stackoverflow.com/search), ' +
                              'or refer to the related and linked questions on the right-hand side of the page to find an answer. ' +
                              'If you have a related but different question, [ask a new question](//stackoverflow.com/questions/ask), ' +
                              'and include a link to this one to help provide context. ' +
                              'See: [Ask questions, get answers, no distractions](//stackoverflow.com/tour)'
                              :userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) + ', this post doesn\'t look like an attempt to answer this question. Every post here is expected to be ' +
                        ...
                        },
                        {
                            ...
                            DisplayName: 'Me too',
                            ReportType: 'AnswerNotAnAnswer',
                            GetComment: function (userDetails) { return  userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) + ', please don\'t add *"Me too"* as answers. It doesn\'t actually provide an answer to the question. ' +
                        ...
                        },
                        {
                            ...
                            DisplayName: 'Library',
                            ReportType: 'AnswerNotAnAnswer',
                            GetComment: function (userDetails) { return userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) + ', please don\'t just post some tool or library as an answer. At least demonstrate [how it solves the problem](http://meta.stackoverflow.com/a/251605) in the answer itself.'; }
                        },
                        {
                            Id: 10,
                            DisplayName: 'Comment',
                            ReportType: 'AnswerNotAnAnswer',
                            GetComment: function (userDetails) { return  userDetails.AuthorName.split(' ')[0].charAt(0).toUpperCase() + userDetails.AuthorName.split(' ')[0].slice(1) +', this does not provide an answer to the question. Once you have sufficient [reputation](https://stackoverflow.com/help/whats-reputation) you will be able to [comment on any post](https://stackoverflow.com/help/privileges/comment); instead, [provide answers that don\'t require clarification from the asker](https://meta.stackexchange.com/questions/214173/why-do-i-need-50-reputation-to-comment-what-can-i-do-instead).'; }
                        },
                        {
                            Id: 14,
