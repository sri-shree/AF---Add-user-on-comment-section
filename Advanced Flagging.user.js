                    ...
                    FlagTypes: [
                        {
                            ...
                            GetComment: function (userDetails) { return  userDetails.Reputation == 1  ?'Welcome to StackOverflow '+ userDetails.AuthorName +
                        ...
                        },
                        {
                            ...
                            ReportType: 'AnswerNotAnAnswer',
                            GetComment: function (userDetails) { return userDetails.Reputation == 1  ?'Welcome to StackOverflow '+ userDetails.AuthorName +'. However, this does not provide an answer to the question.You can [search for similar questions](//stackoverflow.com/search), ' +
